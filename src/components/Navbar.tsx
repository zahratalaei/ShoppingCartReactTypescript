import {Button,Nav,Container,Navbar as NavbarBs,Form,NavbarBrand, Image} from 'react-bootstrap'
...
const Navbar = () => {
  ...
  return (
    <NavbarBs className='shadow-sm mb-1' sticky='top' bg='dark' variant='dark' >
     <Container fluid>
      <NavbarBrand href='/' className='fw-bold'>
        ShopEase</NavbarBrand>
          <Nav className='fs-5'>
